export default function init(userInfo,callbacks) {
    ...
    //公有云初始化
    RongIMLib.RongIMClient.init('0vnjpoad0310z');
    ...
    //开始链接
    var token = '40fQ75q/l7sbO5sEfZZtKQ/MeVAFbziQOLcKtSFa1/HZ/+mI5iBT9B40ug3nZB1tYXJBq0Gh6pBGfu61QycNaw=='
    RongIMClient.connect(token, {
        onSuccess: function (id) {
            console.log('Connect successfully. ' + id);
